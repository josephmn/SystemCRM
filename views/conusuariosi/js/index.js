$(function () {
  ...
  $("#example1 tbody").on("click", "a.editar", function () {
    ...
    $.ajax({
      type: "POST",
      url: "/recursoshumanos/conusuariosi/consulta_usuario",
  ...
  $("#btnguardar").on("click", function () {
    ...
    Swal.fire({
      ...
      if (result.value) {
        $.ajax({
          type: "POST",
          url: "/recursoshumanos/conusuariosi/mantenimiento_usuarios",
          data: {
            post: post,
            dni: dni,
            estado: estado,
  ...
  $("#example1 tbody").on("click", "a.password", function () {
    ...
    Swal.fire({
      ...
      if (result.value) {
        $.ajax({
          type: "POST",
          url: "/recursoshumanos/conusuariosi/cambiar_password",
          data: { dni: dni },
          success: function (res) {
            if (res.icase < 4) {
              Swal.fire({
  ...
  $("#btnenviarcorreo").on("click", function () {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          type: "POST",
          url: "/recursoshumanos/conusuariosi/enviarcorreo",
          data: {
            cnombre: cnombre,
            cpara: cpara,
            ccopia: ccopia,
...
function comboperfil(perfil) {
  $.ajax({
    type: "POST",
    url: "/recursoshumanos/conusuariosi/comboperfil",
    data: { perfil: perfil },
    success: function (res) {
      $("#perfil").html("");
...
function combocorreos(post, id) {
  $.ajax({
    type: "POST",
    url: "/recursoshumanos/conusuariosi/combocorreos",
