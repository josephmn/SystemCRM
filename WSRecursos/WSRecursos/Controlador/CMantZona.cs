...
{
    public class CMantZona
    {
        public List<EMantenimiento> MantZona(SqlConnection con, Int32 id, Int32 zona, String nombre, Int32 estado, String user)
        {
            List<EMantenimiento> lEMantenimiento = null;
            SqlCommand cmd = new SqlCommand("ASP_MANT_ZONA", con);
