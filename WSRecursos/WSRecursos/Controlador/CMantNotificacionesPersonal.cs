...
{
    public class CMantNotificacionesPersonal
    {
        public List<EMantenimiento> MantNotificacionesPersonal(SqlConnection con, 
            Int32 post,
            Int32 id,
            String dni)
        {
            List<EMantenimiento> lEMantenimiento = null;
            SqlCommand cmd = new SqlCommand("ASP_MANT_NOTIFICACIONES_PERSONAL", con);
