...
{
    public class CMantFotoPerfil
    {
        public List<EMantenimiento> MantFotoPerfil(SqlConnection con, String dni, String nombre, String ruta)
        {
            List<EMantenimiento> lEMantenimiento = null;
            SqlCommand cmd = new SqlCommand("ASP_FOTO_PERFIL", con);
