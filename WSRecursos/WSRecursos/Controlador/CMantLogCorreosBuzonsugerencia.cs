...
{
    public class CMantLogCorreosBuzonsugerencia
    {
        public List<EMantenimiento> MantLogCorreosBuzonsugerencia(SqlConnection con, 
            Int32 post,
            String ticket,
            String para,
            String copia,
            ...
            String user)
        {
            ...
            SqlCommand cmd = new SqlCommand("ASP_LOG_CORREOS_BUZON", con);
            ...
            cmd.Parameters.AddWithValue("@asunto", SqlDbType.Int).Value = asunto;
            cmd.Parameters.AddWithValue("@desc_asunto", SqlDbType.VarChar).Value = desc_asunto;
