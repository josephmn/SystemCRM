...
{
    public class CMantControlRemoto
    {
        public List<EMantenimiento> MantControlRemoto(SqlConnection con,
            Int32 post,
            Int32 id,
            String user
            )
        {
            ...
            SqlCommand cmd = new SqlCommand("ASP_MANT_CONTROL_REMOTO", con);
