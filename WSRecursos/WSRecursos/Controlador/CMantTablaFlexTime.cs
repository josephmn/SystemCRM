...
{
    public class CMantTablaFlexTime
    {
        public List<EMantenimiento> MantTablaFlexTime(SqlConnection con,
            Int32 post,
            Int32 id,
            Int32 semana,
            Int32 flex,
            ...
            )
        {
            ...
            SqlCommand cmd = new SqlCommand("ASP_MANT_TABLA_FLEX_TIME", con);
