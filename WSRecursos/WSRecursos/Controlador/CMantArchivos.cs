...
{
    public class CMantArchivos
    {
        public List<EMantenimiento> MantArchivos(SqlConnection con,
            Int32 post,
            Int32 id,
            String nombre,
            String mime,
            ...
            String dni)
        {
            ...
            SqlCommand cmd = new SqlCommand("ASP_MANT_ARCHIVO", con);
            ...
            cmd.Parameters.AddWithValue("@icono", SqlDbType.VarChar).Value = icono;
