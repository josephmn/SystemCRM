...
{
    public class CMantLogBoletas
    {
        public List<EMantenimiento> MantLogBoletas(SqlConnection con, String dni, String nroboleta, String ip)
        {
            List<EMantenimiento> lEMantenimiento = null;
            SqlCommand cmd = new SqlCommand("ASP_LOG_BOLETAS", con);
