...
{
    public class CMantControlFlexTime
    {
        public List<EMantenimiento> MantControlFlexTime(SqlConnection con,
            Int32 post,
            Int32 id,
            String user
            )
        {
            ...
            SqlCommand cmd = new SqlCommand("ASP_MANT_CONTROL_TABLA_FLEX_TIME", con);
