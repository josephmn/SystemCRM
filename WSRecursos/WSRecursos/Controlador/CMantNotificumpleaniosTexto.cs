...
{
    public class CMantNotificumpleaniosTexto
    {
        public List<EMantenimiento> MantNotificumpleaniosTexto(SqlConnection con,
            Int32 post,
            Int32 id,
            Int32 icumple,
            String texto,
            ...
            String user)
        {
            ...
            SqlCommand cmd = new SqlCommand("ASP_MANT_NOTIFICUMPLEANIOS_TEXTO", con);
            cmd.CommandType = CommandType.StoredProcedure;

            cmd.Parameters.AddWithValue("@post", SqlDbType.Int).Value = post;
            cmd.Parameters.AddWithValue("@id", SqlDbType.Int).Value = id;
            cmd.Parameters.AddWithValue("@icumple", SqlDbType.Int).Value = icumple;
            ...
            cmd.Parameters.AddWithValue("@alineacion", SqlDbType.Int).Value = alineacion;
            cmd.Parameters.AddWithValue("@fuente", SqlDbType.Int).Value = fuente;
