...
{
    public class CMantFirma
    {
        public List<EMantenimiento> MantFirma(SqlConnection con, String dni, String nombre, String ruta)
        {
            List<EMantenimiento> lEMantenimiento = null;
            SqlCommand cmd = new SqlCommand("ASP_FIRMA_PERFIL", con);
