...
namespace WSRecursos.Controller
{
    ...
    {
        public List<EMantenimiento> MantLogCorreos(SqlConnection con, Int32 post, String ticket, String para, String copia, String asunto, String mensaje, Int32 output, String ruta, String user)
        {
