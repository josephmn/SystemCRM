...
{
    public class CMantConveniosEducativos
    {
        public List<EMantenimiento> MantConveniosEducativos(SqlConnection con, 
            Int32 post,
            Int32 id,
            Int32 condicion,
            String nombre,
            ...
            String user)
        {
            ...
            SqlCommand cmd = new SqlCommand("ASP_MANT_CONVENIOS_EDUCATIVOS", con);
            ...
            cmd.Parameters.AddWithValue("@tarjeta", SqlDbType.VarChar).Value = tarjeta;
