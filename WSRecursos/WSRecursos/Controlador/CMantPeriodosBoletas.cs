...
{
    public class CMantPeriodosBoletas
    {
        public List<EMantenimiento> MantPeriodosBoletas(SqlConnection con, Int32 post, Int32 id, String periodo, Int32 estado, String firma, String user)
        {
            List<EMantenimiento> lEMantenimiento = null;
            SqlCommand cmd = new SqlCommand("ASP_MANT_PERIODOS_BOLETAS", con);
            ...
            cmd.Parameters.AddWithValue("@firma", SqlDbType.VarChar).Value = firma;
