...
{
    public class CMantLogCTS
    {
        public List<EMantenimiento> MantLogCTS(SqlConnection con, String dni, String periodo, String ip)
        {
            List<EMantenimiento> lEMantenimiento = null;
            SqlCommand cmd = new SqlCommand("ASP_LOG_CTS", con);
