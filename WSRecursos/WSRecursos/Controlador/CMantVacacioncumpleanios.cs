...
{
    public class CMantVacacioncumpleanios
    {
        public List<EMantenimiento> MantVacacioncumpleanios(SqlConnection con,
            Int32 post,
            Int32 id,
            String fecha,
            String user
            )
        {
            ...
            SqlCommand cmd = new SqlCommand("ASP_MANT_VACACION_CUMPLEANIOS", con);
